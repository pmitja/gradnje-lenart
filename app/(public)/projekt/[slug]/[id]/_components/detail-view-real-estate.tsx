          ...
          <div className="z-10 flex flex-col items-center gap-y-4">
            <div className="w-full rounded-xl bg-gradient-to-r from-destructive-300 to-destructive-200 p-4 text-center text-white shadow-lg">
              <h3 className="text-xl font-semibold leading-none tracking-tight lg:text-2xl">
                {type === LocationType.Apartments ? 'Stanovanje je prodano.' : 'Hiša je prodana.'}
              </h3>
            </div>

            <div className="flex w-full place-content-center items-start gap-3 rounded-xl border border-destructive-200 bg-destructive-50 p-4 text-secondary-300 shadow-sm">
              <InfoIcon className="mt-0.5 shrink-0" size={20} />
              <p className="text-sm">
                Ta nepremičnina je bila prodana. Oglejte si druge razpoložljive nepremičnine.
              </p>
            </div>
            ...
            <Button
              variant={'secondary'}
              onClick={handleBack}
              className="mt-2 px-6 py-2.5 shadow-md transition-transform hover:scale-105"
            >
              Pojdi nazaj
            </Button>
          </div>
