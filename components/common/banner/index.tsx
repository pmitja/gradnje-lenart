...
export default function Banner() {
  return (
    <div className="fixed inset-x-0 top-0 z-10 w-full bg-primary-100 text-secondary-400">
      <div className="container mx-auto py-2">
        <div className="flex flex-col items-center justify-between text-sm sm:flex-row">
          <div className="mb-2 flex items-center space-x-2 transition-colors hover:text-body-200 sm:mb-0">
