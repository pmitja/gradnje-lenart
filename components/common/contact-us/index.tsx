  ...
  <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
    <div className="bg-pattern rounded-xl bg-primary-200 p-6">
      <div className="flex justify-between">
        <p className="mb-3 text-2xl font-bold text-body-200 md:text-3xl">Kontaktni podatki</p>
      ...
      <div className="mb-5 text-secondary-400">
        ...
        <a href="tel:+38641638451" target="_blank" className="transition-colors hover:text-body-200">
        041 638 451
        </a>
      </div>
      <div className="mb-5 text-secondary-400">
        <Mail size={18} className="mr-8 inline-block" />
        <a href="mailto:info@gradnje-plus.si" target="_blank" className="transition-colors hover:text-body-200">
