      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mb-12 text-lg text-secondary-300">
            Ponosni smo na številke, ki govorijo o naši predanosti in uspehu.
            Z vsakim projektom postavljamo nove standarde kakovosti.
          </p>
          ...
          >
            ...
            <p className="text-secondary-300">
              ...
              uspešno izvedenih projektov in izkušenj, ki smo jih pridobili skozi leta delovanja
              na nepremičninskem trgu. Vsak projekt, vsaka stranka in vsaka izkušnja nas naredi
              boljše in nam pomaga, da rastemo kot podjetje, ki postavlja nove standarde na
              področju razvoja nepremičnin.
            </p>
          </motion.div>
        </motion.div>
      </div>
