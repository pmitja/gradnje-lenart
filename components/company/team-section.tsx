        ...
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          >
            <div className="rounded-xl bg-gradient-to-r from-primary-200 to-primary-400 p-8 shadow-lg">
              <h3 className="mb-4 text-2xl font-bold text-white">Naša filozofija</h3>
              <p className="text-lg leading-relaxed text-white">{culture}</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="rounded-xl bg-body-75 p-8 shadow-md">
              ...
              <p className="text-secondary-300">
                Zavezani smo k zmanjšanju našega okoljskega odtisa in spodbujanju trajnostnih praks
                v gradbeništvu.
              </p>
            </div>
          </motion.div>
