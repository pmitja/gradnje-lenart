    ...
    <section className="bg-body-75 py-16 md:py-24" id="timeline">
      ...
      >
        <div className="text-center">
          <h2 className="mb-6 text-3xl font-bold text-secondary-400 md:text-4xl">Naša zgodovina</h2>
          <p className="mx-auto mb-12 max-w-3xl text-lg text-secondary-300">
            Spoznajte ključne trenutke, ki so oblikovali našo pot in nas naredili vodilno podjetje
        ...
        <div className="hidden md:block">
                  ...
                  >
                    <span
                      className={`absolute -bottom-8 text-sm font-bold ${
                        index === activeIndex ? 'text-primary-400' : 'text-secondary-200'
                      }`}
                    >
                      {milestone.year}
                    </span>
          ...
          >
            ...
            <p className="text-lg text-secondary-300">{milestones[activeIndex].description}</p>
          </motion.div>
        </div>
        ...
        <div className="md:hidden">
          ...
          >
            ...
            <p className="text-secondary-300">{milestones[activeIndex].description}</p>
          </motion.div>
            ...
            {milestones.map((_, index) => (
              <button
                ...
                className={`size-2 rounded-full ${
                  index === activeIndex ? 'bg-primary-300' : 'bg-secondary-100'
                }`}
              />
            ))}
          </div>
