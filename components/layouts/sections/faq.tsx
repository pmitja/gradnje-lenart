...
const Faq = () => (
  <section className="my-6 flex flex-col justify-between gap-10 md:my-10 lg:my-28 lg:flex-row lg:gap-8" id='faq'>
    ...
    >
      <AccordionItem value="item-1">
        ...
        <AccordionContent className="font-archivo text-base leading-5 text-secondary-200">
          Iskanje, ogled, finančno načrtovanje, oddaja ponudbe in pogajanja tvorijo osnovne korake v
          postopku nakupa nepremičnine. Predhodna odobritev kredita in posvet s strokovnjakom sta
          ključna. Oddana ponudba pripelje do dogovora in nakupa. Za več informacij smo na voljo.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-6">
        <AccordionTrigger className="border-b border-primary-100 py-6 text-xl leading-tight text-secondary-200">
          Kako se ukvarjate z morebitnimi težavami v soseski, na primer glede hrupa ali parkiranja?
        </AccordionTrigger>
        <AccordionContent className="font-archivo text-base leading-5 text-secondary-200">
          Iskanje, ogled, finančno načrtovanje, oddaja ponudbe in pogajanja tvorijo osnovne korake v
          postopku nakupa nepremičnine. Predhodna odobritev kredita in posvet s strokovnjakom sta
