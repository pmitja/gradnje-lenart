...
export default function PropertyListingSection() {
  ...
  const filterProperties = (propertiesList: RealEstate[]) => propertiesList.filter((property) => {
    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-secondary-900 text-3xl font-bold">Izpostavljene nepremičnine</h2>
