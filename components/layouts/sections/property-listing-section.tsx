      ...
      <div className="space-y-3 p-4">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <Button variant="outline" asChild>
            <Link href={`/projekt/${property.location.slug}/${property.id}`}>Podrobnosti</Link>
          </Button>
        </div>
      </div>
    </div>
...
const EmptyResults = ({ onReset }: { onReset: () => void }) => (
  <div className="flex h-40 min-h-fit flex-col items-center justify-center rounded-lg border border-gray-100 bg-gray-50 p-8 text-center">
    <h3 className="text-secondary-700 text-xl font-semibold">Ni najdenih nepremičnin</h3>
...
const PROPERTY_TYPES = [
  {
    id: 'all',
    label: 'Vse nepremičnine',
  },
  {
    id: 'Večstanovanjski objekt',
    label: 'Večstanovanjski objekti',
  },
  {
    id: 'Hiša',
    label: 'Hiše',
...
export default function PropertyListingSection() {
  ...
  const renderContent = () => {
    ...
    return (
      <>
        <div className="grid min-h-fit grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
  ...
  return (
    <section className="py-8 md:py-16">
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0">{renderFilterTabs()}</div>
      </div>
